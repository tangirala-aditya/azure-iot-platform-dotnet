...
namespace Mmm.Iot.Functions.DeviceLinking.Shared
{
    public class CosmosOperations
    {
        ...
        public async Task<bool> CreateCollectionIfNotExistsAsync(string cosmosDatabase, string cosmosColection, int docDBRUs, string operation)
        {
            bool status = false;
            try
            {
        ...
        public async Task<Document> SaveDocumentAsync(string collectionId, string key, string input, string collectionLink, Guid? id = null, string eTag = null)
        {
            try
            {
                var response = await this.client.UpsertDocumentAsync(
                    collectionLink,
                    new KeyValueDocument(collectionId, key, input, id),
                    IfMatch(eTag));
        ...
        public async Task<Document> GetDocumentAsync(string collectionLink, string collectionId, string key)
        {
            try
            {
