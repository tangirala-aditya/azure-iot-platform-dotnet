...
class NumberInput extends React.Component {
    constructor(props) {
        ...
        this.onKeyDown = (event) => {
            ...
            // Allow numbers
            if (
                event.keyCode >= Common_1.keyCode.num0 &&
                event.keyCode <= Common_1.keyCode.num9
            ) {
                return;
            }
            // Allow numpad numbers
            if (
                event.keyCode >= Common_1.keyCode.numpad0 &&
                event.keyCode <= Common_1.keyCode.numpad9
            ) {
                return;
            }
            if (
                ...
                (event.keyCode === Common_1.keyCode.dash ||
                    event.keyCode === Common_1.keyCode.firefoxDash) &&
    ...
    getValue(value) {
        ...
        const decimalSeparator = ".",
            decimalSplit = value.split(decimalSeparator);
    ...
    render() {
        const inputAttr =
                this.props.attr && this.props.attr.input
                    ...
                    : {},
            attr = Object.assign({}, this.props.attr || {}, {
                input: Object.assign({}, inputAttr, {
        ...
        return React.createElement(TextInput_1.TextInput, {
