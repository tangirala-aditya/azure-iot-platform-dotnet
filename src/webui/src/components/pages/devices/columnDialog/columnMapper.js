...
const defaultIcons = {
    ...
    moveRight: <span className="ms-Icon ms-Icon--ChevronRight" />,
    moveAllRight: [
        <span key={0} className="ms-Icon ms-Icon--DoubleChevronRight" />,
    ],
...
class ColumnMapper extends React.Component {
    ...
    toggleSelected(toggleItems, controlKey) {
        ...
        if (controlKey === "selected") {
            return Object.keys(toggleItemsMap).map(
                (key) => toggleItemsMap[key]
            );
        }
