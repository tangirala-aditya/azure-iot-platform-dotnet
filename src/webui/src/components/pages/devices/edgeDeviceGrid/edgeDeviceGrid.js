...
import { singleSelectCheckboxColumn } from "components/shared/pcsGrid/pcsGridConfig";
import { LinkOrUnlinkDeviceContainer } from "../flyouts/linkOrUnlinkDevices";
 ...
 */
export class EdgeDevicesGrid extends Component {
    constructor(props) {
        super(props);
    ...
    getOpenFlyout = () => {
        ...
        switch (this.state.openFlyoutName) {
            ...
            case "linkOrUnlinkDevice":
                return (
                    <LinkOrUnlinkDeviceContainer
                        onClose={this.closeFlyout}
                        devices={this.deviceGridApi.getSelectedRows()}
